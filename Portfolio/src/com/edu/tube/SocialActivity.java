...
import com.edu.adapter.SocialListAdapter;
...
public class SocialActivity extends Activity
{
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		menuitem = getResources().getStringArray(R.array.social_item);
		Log.e("beforemessage", "4");
		menutext=getResources().getStringArray(R.array.social_text);
		Log.e("beforemessage", "5");
		//menuicon=getResources().getString(R.array.menu_icon);
		Log.e("beforemessage", "6");
		listView = (ListView) findViewById(R.id.social_list);
	Log.e("messeg", "1");
...
//String mess = getResources().getString(R.string.mess_1);
							...
							movie.setThumbnailUrl("drawable://" + R.drawable.facebook_icon);
...
/*					}
		...
		//AppController.getInstance().addToRequestQueue(movieReq);
						adapter = new SocialListAdapter(this, movieList);
						Log.e("messeg", ""+3);
